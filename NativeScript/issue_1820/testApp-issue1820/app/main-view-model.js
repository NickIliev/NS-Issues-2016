...
var DemoAppModel = (function (_super) {
  ...
  DemoAppModel.prototype.doCreateBanner = function (size) {
    admob.createBanner({
      ...
      testing: true,
      size: size,
      iosBannerId: "ca-app-pub-3448279491566733/3137621201",
      androidBannerId: "ca-app-pub-3448279491566733/3137621201",
  ...
  DemoAppModel.prototype.doCreateInterstitial = function () {
    admob.createInterstitial({
      testing: true,
      iosInterstitialId: "ca-app-pub-3448279491566733/3137621201",
      androidInterstitialId: "ca-app-pub-3448279491566733/3137621201",
      // Android automatically adds the connected device as test device with testing:true, iOS does not
      iosTestDeviceIds: ["ce97330130c9047ce0d4430d37d713b1"]
    }).then(
        function() {
          console.log("admob createInterstitial done");
          console.log("topmost at createInterstitial() : " + frameModule.topmost());
        },
        function(error) {

...
var RadDataForm = (function (_super) {
    ...
    RadDataForm.prototype._addArrayFromBuilder = function (name, value) {
        if (name === "groups") {
            console.log("_addArrayFromBuilder: Groups: " + value);
            this.groups = value;
        }
        if (name === "properties") {
            console.log("_addArrayFromBuilder: Properties: " + value);
    ...
    RadDataForm.commitModeProperty = new dependencyObservable.Property("commitMode", "RadDataForm", new proxy_1.PropertyMetadata(undefined, dependencyObservable.PropertyMetadataSettings.None, RadDataForm.onCommitModePropertyChanged));
    RadDataForm.validationModeProperty = new dependencyObservable.Property("validationMode", "RadDataForm", new proxy_1.PropertyMetadata(undefined, dependencyObservable.PropertyMetadataSettings.AffectsLayout, RadDataForm.onValidationModePropertyChanged));
...
var PropertyGroup = (function (_super) {
    ...
    PropertyGroup.prototype._addArrayFromBuilder = function (name, value) {
        console.log("_addArrayFromBuilder: Properties in a group: " + value);
        if (name === "properties") {
            this.properties = value;
        }
    };
...
var DataFormStyleBase = (function (_super) {
    ...
    DataFormStyleBase.strokeColorProperty = new dependencyObservable.Property("strokeColor", "GroupTitleStyle", new proxy_1.PropertyMetadata(undefined, undefined, undefined));
    DataFormStyleBase.strokeWidthProperty = new dependencyObservable.Property("strokeWidth", "PaletteEntry", new proxy_1.PropertyMetadata(undefined, undefined, undefined));
    DataFormStyleBase.fillColorProperty = new dependencyObservable.Property("fillColor", "GroupTitleStyle", new proxy_1.PropertyMetadata(undefined, undefined, undefined));
    DataFormStyleBase.separatorColorProperty = new dependencyObservable.Property("separatorColor", "GroupTitleStyle", new proxy_1.PropertyMetadata(undefined, undefined, undefined));
    DataFormStyleBase.labelTextColorProperty = new dependencyObservable.Property("labelTextColor", "GroupTitleStyle", new proxy_1.PropertyMetadata(undefined, undefined, undefined));
    DataFormStyleBase.labelTextSizeProperty = new dependencyObservable.Property("labelTextSize", "GroupTitleStyle", new proxy_1.PropertyMetadata(undefined, undefined, undefined));
    DataFormStyleBase.labelFontNameProperty = new dependencyObservable.Property("labelFontName", "GroupTitleStyle", new proxy_1.PropertyMetadata(undefined, undefined, undefined));
    DataFormStyleBase.labelFontStyleProperty = new dependencyObservable.Property("labelFontStyle", "GroupTitleStyle", new proxy_1.PropertyMetadata(undefined, undefined, undefined));
...
var EntityProperty = (function (_super) {
    ...
    EntityProperty.onConverterPropertyChanged = function (data) {
        // let prop = <EntityProperty>data.object;
    ...
    EntityProperty.prototype._addArrayFromBuilder = function (name, value) {
        if (name === "validators") {
            console.log("_addArrayFromBuilder: Validators: " + value);
    ...
    // protected onConverterChanged(data: dependencyObservable.PropertyChangeData) {
    ...
    Object.defineProperty(EntityProperty.prototype, "valuesProvider", {
        // get converter(): any {
        //     return this._getValue(EntityProperty.validatorProperty);
        // }
        // set converter(value: any) {
        //     this._setValue(EntityProperty.validatorProperty, value);
        // }
        get: function () {

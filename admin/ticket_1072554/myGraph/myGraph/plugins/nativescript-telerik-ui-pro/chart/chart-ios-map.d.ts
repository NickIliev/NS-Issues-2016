declare class TKChart {
    ...
    public selectionMode: TKChartSelectionMode; //deprecated
    public dataPointSelectionMode : TKChartSelectionMode;
    public seriesSelectionMode :  TKChartSelectionMode;
...
declare class TKChartPieSeries extends TKChartSeries {
    ...
    public selectionMode: TKChartSeriesSelectionMode; //deprecated  
    public selection: TKChartSeriesSelection;
...
declare enum TKChartSeriesSelection {

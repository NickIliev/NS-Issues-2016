 ...
 * 
 * @example
 * ' &lt;DateTimeCategoricalAxis cartesianHorizontalAxis dateFormat="yyyy-MM-dd" verticalLocation="Bottom"&gt;&lt;/DateTimeCategoricalAxis&gt; '
 */
 ...
 * 
 * @example
 * ' &lt;DateTimeContinuousAxis cartesianHorizontalAxis dateFormat="yyyy-MM-dd" verticalLocation="Bottom"&gt;&lt;/DateTimeContinuousAxis&gt; '
 */
 ...
 * 
 * @example
 * ' &lt;LogarithmicAxis cartesianHorizontalAxis dateFormat="yyyy-MM-dd" verticalLocation="Bottom"&gt;&lt;/LogarithmicAxis&gt; '
 */
 ...
 * 
 * @example
 * ' &lt;LineSeries cartesianSeries [items]="items" categoryProperty="Country" valueProperty="Amount"&gt;&lt;/LineSeries&gt; '
 */
 ...
 * 
 * @example
 * ' &lt;AreaSeries cartesianSeries [items]="items" categoryProperty="Country" valueProperty="Amount"&gt;&lt;/AreaSeries&gt; '
 */
 ...
 * 
 * @example
 * ' &lt;BarSeries cartesianSeries seriesName="Bar" stackMode="Stack" [items]="items" categoryProperty="Country" valueProperty="Amount"&gt;&lt;/BarSeries&gt; '
 */
 ...
 * 
 *  @example
 * ' &lt;RangeBarSeries cartesianSeries [items]="rangeItems" showLabels="true" legendTitle="Ranges" categoryProperty="Name" lowPropertyName="Low" highPropertyName="High"&gt;&lt;/RangeBarSeries&gt; '
 */
 ...
 * 
 * @example
 * ' &lt;BubbleSeries cartesianSeries [items]="highDataModel" bubbleScale="5" categoryProperty="Year" valueProperty="Amount" bubbleSizeProperty="Impact"&gt;&lt;/BubbleSeries&gt; '
 */
 ...
 * 
 * @example
 * ' &lt;ScatterBubbleSeries cartesianSeries [items]="highDataModel" bubbleScale="5" xProperty="Year" yProperty="Amount" bubbleSizeProperty="Impact"&gt;&lt;/ScatterBubbleSeries&gt; '
 */
 ...
 * @example
 * ' &lt;ScatterSeries cartesianSeries [items]="highDataModel" bubbleScale="5" xProperty="Year" yProperty="Amount" bubbleSizeProperty="Impact"&gt;&lt;/ScatterSeries&gt; '
 */
 ...
 * 
 * @example
 * ' &lt;Palette cartesianPalette seriesName="Bar" [entries]="myEntries"&gt;&lt;/Palette&gt; '
 */
 ...
 * 
 * @example
 * ' &lt;PieSeries pieSeries [items]="items" selectionMode="DataPoint" expandRadius="1.3" outerRadiusFactor="0.7" valueProperty="Amount" showPercentage="true" showLabels="true" seriesName="MyPie" legendLabel="Country"&gt;&lt;/PieSeries&gt; '
 */
 ...
 * 
 * @example
 * ' &lt;DonutSeries pieSeries [items]="items" valueProperty="Amount"  showPercentage="true" showLabels="true" seriesName="MyPie" legendLabel="Country"&gt;&lt;/DonutSeries&gt; '
 */
 ...
 * 
 * @example
 * ' &lt;CandlestickSeries cartesianSeries categoryProperty="Date" openPropertyName="Open" highPropertyName="High" lowPropertyName="Low" closePropertyName="Close" [items]="candleStickSourceItems"&gt;&lt;/CandlestickSeries&gt; '
 */
 ...
 * 
 * @example
 * ' &lt;OhlcSeries cartesianSeries categoryProperty="Date" openPropertyName="Open" highPropertyName="High" lowPropertyName="Low" closePropertyName="Close" [items]="ohlcSourceItems"&gt;&lt;/OhlcSeries&gt; '
 */
 ...
 * 
 * @example
 * ' &lt;PointLabelStyle lineLabelStyle margin="15" fillcolor="blue"&gt;&lt;/PointLabelStyle&gt; '
 */
 ...
 * 
 *  @example
 * ' &lt;RadCartesianChartGrid cartesianGrid horizontalLinesVisible="true" verticalLinesVisible="true" horizontalStripLinesVisible="true" verticalStripLinesVisible="true" verticalStrokeColor="#804d0026" horizontalStrokeColor="#ffffcc80" horizontalStrokeWidth="2" verticalStrokeWidth=" 3" horizontalStripLineColor="#8059005c, #804d0026"&gt;&lt;/RadCartesianChartGrid&gt; '
 */
export class RadCartesianGridDirective { }

/**
 * Directive identifying the TrackballDirective.
 * 
 * @example
 * ' &lt;Trackball cartesianTrackball snapMode="AllClosestPoints" showIntersectionPoints="true"&gt;&lt;/Trackball&gt; '
 */
 ...
 * 
 *  @example
 * ' &lt;ChartGridLineAnnotation cartesianAnnotations axisId="hAxis" hidden="false" value="50" zPosition="AboveSeries" strokeWidth="1" strokeColor="#EB916580"&gt;&lt;/ChartGridLineAnnotation&gt; '
 */
 ...
 * 
 *  @example
 * ' &lt;ChartPlotBandAnnotation cartesianAnnotations axisId="vAxis" hidden="false" value="20000" zPosition="AboveSeries" minValue="2500" maxValue="5000" fillColor="#AC74E880" strokeColor="#AC74E880"&gt;&lt;/ChartPlotBandAnnotation&gt; '
 */
 ...
 * @example
 * ' &lt;ChartGridLineAnnotation cartesianAnnotations &gt;&lt;/ChartGridLineAnnotation&gt; '
 */

...
var ChartDelegateImpl = (function (_super) {
    ...
    ChartDelegateImpl.prototype.chartPaletteItemForSeriesAtIndex = function (chart, series, index) {
        ...
        if (series.isSelected &&
            (TKChartSeriesSelection.TKChartSeriesSelectionSeries == series.selection ||
                TKChartSeriesSelectionMode.TKChartSeriesSelectionModeSeries == chart.selectionMode)) {
        ...
        if (series.pointIsSelected(index) &&
            (TKChartSeriesSelection.TKChartSeriesSelectionDataPoint == series.selection ||
                TKChartSeriesSelection.TKChartSeriesSelectionDataPointMultiple == series.selection ||
                TKChartSeriesSelectionMode.TKChartSeriesSelectionModeDataPoint == chart.selectionMode)) {
...
var RadPieChart = (function (_super) {
    ...
    function RadPieChart() {
        ...
        this._ios.dataPointSelectionMode = TKChartSelectionMode.TKChartSelectionModeNone;
        this._ios.seriesSelectionMode = TKChartSelectionMode.TKChartSelectionModeNone;
    ...
    RadPieChart.prototype.addSeries = function (newSeries) {
        ...
        if (this.chartPalette) {
            this.series.getItem(0).ios.style.paletteMode = TKChartSeriesStylePaletteMode.TKChartSeriesStylePaletteModeUseItemIndex;
    ...
    RadPieChart.prototype.onSeriesSelectionModeChanged = function (data) {
        ...
        if (data.newValue) {
            if (publicEnumModule.ChartSelectionMode.Single === data.newValue) {
                this.ios.seriesSelectionMode = TKChartSelectionMode.TKChartSelectionModeSingle;
            }
            else if (publicEnumModule.ChartSelectionMode.Multiple === data.newValue) {
                this.ios.seriesSelectionMode = TKChartSelectionMode.TKChartSelectionModeMultiple;
            }
            else if (publicEnumModule.ChartSelectionMode.None === data.newValue) {
                this.ios.seriesSelectionMode = TKChartSelectionMode.TKChartSelectionModeNone;
            }
        }
    };
    RadPieChart.prototype.onPointSelectionModeChanged = function (data) {
        ...
        if (data.newValue) {
            if (publicEnumModule.ChartSelectionMode.Single === data.newValue) {
                this.ios.dataPointSelectionMode = TKChartSelectionMode.TKChartSelectionModeSingle;
            }
            else if (publicEnumModule.ChartSelectionMode.Multiple === data.newValue) {
                this.ios.dataPointSelectionMode = TKChartSelectionMode.TKChartSelectionModeMultiple;
            }
            else if (publicEnumModule.ChartSelectionMode.None === data.newValue) {
                this.ios.dataPointSelectionMode = TKChartSelectionMode.TKChartSelectionModeNone;
            }
        }
    };
    return RadPieChart;

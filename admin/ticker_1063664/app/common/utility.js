        ...
        if(!applicationSettingsModule.getBoolean("isShowingModal")) {
            ...
            if(!context) {
                context = {
                    ...
                    message: 'You are leaving the application. Press "Continue" to continue outside of the UH Now APP. Press "Cancel" to return to the UH Now APP.',
                }
            }
            context.type = type;
    ...
    httpRequest: function(viewModel, requestOptions, callback, failCallback) {
        ...
        .catch(function (e) {
            ...
            if(e.message) {
                ...
                else if(app.ios && e.message.includes("")) { // TODO: update with ios UnknownHostException
                    error = nativeExceptions.ios[""] || "Error occurred: " + e.message;
                }
            }
            else {
